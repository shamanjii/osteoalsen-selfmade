            ...
            <div className="mx-auto max-w-7xl px-4 sm:px-6">
                <div className="grid lg:grid-cols-5 gap-10 lg:gap-16 items-start">
                    ...
                    <div className="relative h-[400px] overflow-hidden rounded-xl lg:hidden">
                        <Image src={assetPath("/assets/joshua-alsen-profil.webp")} alt="Joshua Alsen Profilfoto" fill className="object-cover" priority />
                    </div>
                    ...
                    <div className="relative lg:col-span-2 h-[500px] lg:h-[700px] overflow-hidden rounded-xl hidden lg:block">
                        <Image src={assetPath("/assets/joshua-alsen-profil.webp")} alt="Joshua Alsen - Osteopath und Heilpraktiker in Hamburg" fill className="object-cover" priority />
