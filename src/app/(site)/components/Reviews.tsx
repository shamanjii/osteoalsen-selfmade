...
const convertToDisplayFormat = (reviews: Review[]): DisplayReview[] => {
...
const Reviews = memo(function Reviews() {
    ...
    // Use static reviews from fallback data
    const allReviews = useMemo(() => convertToDisplayFormat(fallbackReviews), []);
