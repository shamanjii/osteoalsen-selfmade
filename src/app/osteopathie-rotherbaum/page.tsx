...
export const metadata: Metadata = {
  title: "Osteopath Rotherbaum | VFO-zertifiziert | J. Alsen",
  description:
    "Osteopath Rotherbaum ✓ VFO-zertifiziert ✓ Rappstraße 7 ✓ Termine binnen 48h ✓ Kassenerstattung möglich ⭐ Jetzt Termin buchen!",
  keywords: [
