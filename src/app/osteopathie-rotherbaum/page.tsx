...
export const metadata: Metadata = {
  ...
  keywords: [
    ...
    "Osteopathie Grindel",
    "Osteopathie Universität Hamburg",
  ],
  ...
  return (
    <div className="min-h-screen">
      ...
      <main>
          ...
          faqs={[
            {
              ...
              answer:
                "Die Praxis befindet sich in der Rappstraße 7, 20146 Hamburg-Rotherbaum. Sie ist in 5 Minuten Fußweg von der U-Bahn Hallerstraße erreichbar.",
            },
            {
              question: "Wie komme ich mit der U-Bahn zur Praxis Rotherbaum?",
              answer:
                "U1 bis Hallerstraße – von dort sind es ca. 5 Minuten zu Fuß. Alternativ U2/U3 bis Schlump (ca. 10 Minuten Fußweg).",
            },
            {
              question: "Gibt es Parkplätze in Rotherbaum?",
              answer:
                "In Rotherbaum gibt es Anwohnerparkplätze in den Seitenstraßen sowie kostenpflichtige Parkmöglichkeiten in der Nähe. Ich empfehle, mit ÖPNV oder Fahrrad zu kommen.",
            },
            {
        ...
        />
        <Breadcrumbs items={[{ label: "Osteopathie Rotherbaum" }]} />
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6">
            <div className="text-center max-w-3xl mx-auto mb-12">
              ...
              <p className="text-xl text-slate-600 leading-relaxed mb-8">
                ...
                Ganzheitliche osteopathische Behandlungen im Uni-Viertel.
              </p>
            ...
            <div className="grid md:grid-cols-2 gap-12">
              <div className="space-y-6">
                <div className="bg-slate-50 rounded-xl p-6">
                  ...
                  <p className="text-slate-700 text-lg">
                    ...
                    <br />
                    Praxis im Herzen des Uni-Viertels, zwischen Grindel und Alster.
                  </p>
                </div>
                ...
                <div className="bg-slate-50 rounded-xl p-6">
                  ...
                  <div className="space-y-3 text-slate-700">
                    <div>
                      ...
                      U1 bis Hallerstraße (ca. 5 Min. Fußweg)<br />
                      U2/U3 bis Schlump (ca. 10 Min. Fußweg)
                    </div>
                    <div>
                      <strong className="text-slate-900">Bus:</strong><br />
                      Linien 4, 5, 109 – Haltestelle Grindelhof
                    </div>
                    <div>
                      <strong className="text-slate-900">Fahrrad:</strong><br />
                      StadtRAD-Stationen in der Nähe<br />
                      Fahrradstellplätze vor der Praxis
                    </div>
                    <div>
                      <strong className="text-slate-900">Auto:</strong><br />
                      Anwohnerparkplätze in den Seitenstraßen<br />
              ...
              <div>
                <div className="bg-slate-100 rounded-xl overflow-hidden" style={{ height: '500px' }}>
                  <iframe
                    src="https://maps.google.com/maps?q=Rappstra%C3%9Fe+7,+20146+Hamburg&t=m&z=15&output=embed&iwloc=near"
                    className="w-full h-full"
                    style={{ border: 0 }}
                    allowFullScreen
                    loading="lazy"
                    referrerPolicy="no-referrer-when-downgrade"
                    title="Karte Osteopathie Praxis Hamburg Rotherbaum - Rappstraße 7"
                  ></iframe>
                </div>
              </div>
            </div>
        ...
        <section className="py-16 sm:py-24 bg-slate-50">
          <div className="mx-auto max-w-4xl px-4 sm:px-6">
            <h2 className="text-3xl sm:text-4xl font-bold text-slate-900 text-center mb-8 font-epilogue">
              Osteopathie im Hamburger Uni-Viertel
            </h2>
            <div className="prose prose-lg max-w-none">
              <p className="text-slate-700 leading-relaxed mb-4">
                Rotherbaum ist Hamburgs akademisches Herz: Hier liegen die Universität,
                der Grindelhof und das CCH. Ein Viertel, das Studierende, Wissenschaftler:innen
                und Berufstätige gleichermaßen prägt – und entsprechend hohe Ansprüche an
                medizinische Versorgung hat.
              </p>
              <p className="text-slate-700 leading-relaxed mb-4">
                Die Praxis in der Rappstraße 7 liegt zentral zwischen Universität, Grindelallee
                und der Außenalster. Egal ob Sie aus Eppendorf, Harvestehude, Eimsbüttel oder
                der Innenstadt kommen – der Weg ist kurz.
              </p>
              <h3 className="text-2xl font-semibold text-slate-900 mb-4 mt-8 font-epilogue">
                Was Rotherbaum besonders macht
              </h3>
              <ul className="list-disc list-inside space-y-2 text-slate-700 mb-6">
                <li>Zentrale Lage im Uni-Viertel mit hervorragender ÖPNV-Anbindung</li>
                <li>U-Bahn Hallerstraße in 5 Minuten Fußweg</li>
                <li>Nahe Außenalster und Grindelhof – ideal für Spaziergänge nach der Behandlung</li>
                <li>Gut erreichbar aus Eppendorf, Harvestehude, Eimsbüttel und Innenstadt</li>
                <li>Etablierte Praxisräume in ruhiger Seitenstraße</li>
              </ul>
            </div>
          </div>
        </section>
            ...
            <div className="space-y-4">
              <div className="bg-white border border-slate-200 rounded-lg p-6">
                ...
                <p className="text-slate-600">
                  ...
                  Sie ist in 5 Minuten Fußweg von der U-Bahn Hallerstraße erreichbar.
                </p>
              </div>
              <div className="bg-white border border-slate-200 rounded-lg p-6">
                <h3 className="text-lg font-semibold text-slate-900 mb-2 font-epilogue">
                  Wie komme ich mit der U-Bahn zur Praxis Rotherbaum?
                </h3>
                <p className="text-slate-600">
                  U1 bis Hallerstraße – von dort sind es ca. 5 Minuten zu Fuß. Alternativ
                  U2/U3 bis Schlump (ca. 10 Minuten Fußweg).
                </p>
              </div>
              <div className="bg-white border border-slate-200 rounded-lg p-6">
                <h3 className="text-lg font-semibold text-slate-900 mb-2 font-epilogue">
                  Gibt es Parkplätze in Rotherbaum?
                </h3>
                <p className="text-slate-600">
                  In Rotherbaum gibt es Anwohnerparkplätze in den Seitenstraßen sowie
                  kostenpflichtige Parkmöglichkeiten in der Nähe. Ich empfehle, mit ÖPNV
